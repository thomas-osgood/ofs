...
var file_filehandler_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x77, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xdf, 0x02, 0x0a, 0x0b,
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x0c, 0x44,
	...
	0x22, 0x00, 0x12, 0x45, 0x0a, 0x0a, 0x52, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x46, 0x69, 0x6c, 0x65,
	0x12, 0x1e, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x2e, 0x52,
...
var file_filehandler_proto_depIdxs = []int32{
	...
	5, // 1: filehandler.Fileservice.ListFiles:input_type -> common.Empty
	3, // 2: filehandler.Fileservice.MakeDirectory:input_type -> filehandler.MakeDirectoryRequest
	4, // 3: filehandler.Fileservice.RenameFile:input_type -> filehandler.RenameFileRequest
	2, // 4: filehandler.Fileservice.UploadFile:input_type -> filehandler.FileRequest
	6, // 5: filehandler.Fileservice.DownloadFile:output_type -> common.StatusMessage
	1, // 6: filehandler.Fileservice.ListFiles:output_type -> filehandler.FileInfo
	6, // 7: filehandler.Fileservice.MakeDirectory:output_type -> common.StatusMessage
	6, // 8: filehandler.Fileservice.RenameFile:output_type -> common.StatusMessage
	0, // 9: filehandler.Fileservice.UploadFile:output_type -> filehandler.FileChunk
